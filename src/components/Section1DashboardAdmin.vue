    ...
    <div class="flex flex-row py-24 justify-center max-h-10 w-full items-center gap-6 px-10">
        <div class="bg-white flex flex-row gap-3 px-4 py-6 rounded-2xl min-w-[230px]">
            ...
            <div class="flex flex-col justify-center">
                ...
                <p class="text-[#1E1E1E] font-semibold text-xl">10</p>
            </div>
        </div>
        <div class="bg-white flex flex-row gap-3 px-4 py-6 rounded-2xl min-w-[230px]">
            <div class="bg-[#FFF5D9] p-4 rounded-full items-center">
            ...
            <div class="flex flex-col justify-center">
                ...
                <p class="text-[#1E1E1E] font-semibold text-xl">14</p>
            </div>
        </div>
        <div class="bg-white flex flex-row gap-3 px-4 py-6 rounded-2xl min-w-[230px]">
            <div class="bg-[#FFF5D9] p-4 rounded-full items-center">
            ...
            <div class="flex flex-col justify-center">
                ...
                <p class="text-[#1E1E1E] font-semibold text-xl">20</p>
            </div>
        </div>
        <div class="bg-white flex flex-row gap-3 px-4 py-6 rounded-2xl min-w-[230px]">
            <div class="bg-[#FFF5D9] p-4 rounded-full items-center">
            ...
            <div class="flex flex-col justify-center">
                ...
                <p class="text-[#1E1E1E] font-semibold text-xl">15</p>
            </div>
        </div>
    </div>
</template>